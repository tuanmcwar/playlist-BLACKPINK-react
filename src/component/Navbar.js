...
function Navbar() {
  return (
    <div className="bodyNav text-center sm:h-[3rem] lg:h-[6rem] h-[3rem] w-full fixed ">
      <div className="mo-fire lg:w-12 w-7">
        <svg
          version="1.1"
          id="Layer_1"
	...
	S134.387,164.603,103.143,105.917z"
      ...
      <div className="mo-fire2 lg:w-12 w-7">
        <svg
          version="1.1"
          id="Layer_1"
          xmlns="http://www.w3.org/2000/svg"
    ...
    //   <img
    //     className="Logo-img m-auto lg:w-44 sm:w-20  w-24 pb-1"
    //     src={BP}
    //     alt="avatar"
    //   />
